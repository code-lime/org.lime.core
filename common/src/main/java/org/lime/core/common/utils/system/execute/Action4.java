...
public interface Action4<T0, T1, T2, T3> extends Action1<Tuple2<Tuple2<Tuple2<T0,T1>,T2>,T3>> {
    void invoke(T0 arg0, T1 arg1, T2 arg2, T3 arg3);
    @Override default void invoke(Tuple2<Tuple2<Tuple2<T0,T1>,T2>,T3> arg0) { invoke(arg0.val0.val0.val0, arg0.val0.val0.val1, arg0.val0.val1, arg0.val1); }
