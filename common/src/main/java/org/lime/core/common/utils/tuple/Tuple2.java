...
public class Tuple2<T0, T1> extends BaseTuple {
    public LockTuple2<T0, T1> lock() { return new LockTuple2<>(this); }
    @Override public Object[] getValues() { return new Object[] { val0, val1 }; }
    public Tuple2(T0 val0, T1 val1) { this.val0 = val0; this.val1 = val1; }
    ...
    public void set(Tuple2<T0, T1> other) { this.val0 = other.val0; this.val1 = other.val1; }
    public <A0, A1>Tuple2<A0, A1> map(Func1<T0, A0> map0, Func1<T1, A1> map1) { return Tuple.of(map0.invoke(val0), map1.invoke(val1)); }
