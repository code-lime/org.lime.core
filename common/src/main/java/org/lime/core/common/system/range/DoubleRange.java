...
import org.lime.core.common.system.utils.RandomUtils;

import java.util.stream.IntStream;

public class DoubleRange extends BaseRange {
    public final BaseRange from;
    public final BaseRange to;

    public DoubleRange(BaseRange from, BaseRange to) {
        this.from = from;
        this.to = to;
    }
