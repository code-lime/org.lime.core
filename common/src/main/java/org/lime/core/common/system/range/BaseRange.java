package org.lime.core.common.system.range;

import org.lime.core.common.docs.IIndexGroup;
import org.lime.core.common.docs.json.IComment;
import org.lime.core.common.docs.json.IJElement;
import org.lime.core.common.docs.json.JsonEnumInfo;

import java.util.Arrays;
import java.util.stream.IntStream;

public abstract class BaseRange {
    public static BaseRange parse(String text) {
        if (text.contains(","))
            return new ListRange(Arrays.stream(text.split(",")).map(BaseRange::parse).toList());
