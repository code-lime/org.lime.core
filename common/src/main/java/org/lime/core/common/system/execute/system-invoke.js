...
function createAF(index) {
    ...
    files["Func"+index+".java"] = [
        ...
        "",
        "// Generated by JavaScript (c) Lime",
        "public interface Func"+index+"<"+type+", TResult> extends Callable {",
    ...
    files["ActionEx"+index+".java"] = [
        ...
        "",
        "// Generated by JavaScript (c) Lime",
        "public interface ActionEx"+index+"<"+type+"> extends Callable {",
    ...
    files["FuncEx"+index+".java"] = [
        ...
        "",
        "// Generated by JavaScript (c) Lime",
        "public interface FuncEx"+index+"<"+type+", TResult> extends Callable {",
