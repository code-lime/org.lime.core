...
public class JsonArrayOptional extends JsonElementOptional implements Collection<JsonElementOptional> {
    ...
    @Override public boolean addAll(@NotNull Collection<? extends JsonElementOptional> collection) {
        boolean isAdded = false;
        for (JsonElementOptional item : collection) isAdded = add(item) || isAdded;
        return isAdded;
    }
    @Override public boolean removeAll(@NotNull Collection<?> collection) { return this.elements.removeAll(collection); }
    @Override public boolean retainAll(@NotNull Collection<?> collection) { return this.elements.retainAll(collection); }
