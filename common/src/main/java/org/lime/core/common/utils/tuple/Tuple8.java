...
public class Tuple8<T0, T1, T2, T3, T4, T5, T6, T7> extends BaseTuple {
    public LockTuple8<T0, T1, T2, T3, T4, T5, T6, T7> lock() { return new LockTuple8<>(this); }
    @Override public Object[] getValues() { return new Object[] { val0, val1, val2, val3, val4, val5, val6, val7 }; }
    public Tuple8(T0 val0, T1 val1, T2 val2, T3 val3, T4 val4, T5 val5, T6 val6, T7 val7) { this.val0 = val0; this.val1 = val1; this.val2 = val2; this.val3 = val3; this.val4 = val4; this.val5 = val5; this.val6 = val6; this.val7 = val7; }
    public T0 val0; public T1 val1; public T2 val2; public T3 val3; public T4 val4; public T5 val5; public T6 val6; public T7 val7;
    public T0 get0() { return val0; } public T1 get1() { return val1; } public T2 get2() { return val2; } public T3 get3() { return val3; } public T4 get4() { return val4; } public T5 get5() { return val5; } public T6 get6() { return val6; } public T7 get7() { return val7; }
    ...
    public void set(Tuple8<T0, T1, T2, T3, T4, T5, T6, T7> other) { this.val0 = other.val0; this.val1 = other.val1; this.val2 = other.val2; this.val3 = other.val3; this.val4 = other.val4; this.val5 = other.val5; this.val6 = other.val6; this.val7 = other.val7; }
    public <A0, A1, A2, A3, A4, A5, A6, A7>Tuple8<A0, A1, A2, A3, A4, A5, A6, A7> map(Func1<T0, A0> map0, Func1<T1, A1> map1, Func1<T2, A2> map2, Func1<T3, A3> map3, Func1<T4, A4> map4, Func1<T5, A5> map5, Func1<T6, A6> map6, Func1<T7, A7> map7) { return Tuple.of(map0.invoke(val0), map1.invoke(val1), map2.invoke(val2), map3.invoke(val3), map4.invoke(val4), map5.invoke(val5), map6.invoke(val6), map7.invoke(val7)); }
