...
public class LockTuple8<T0, T1, T2, T3, T4, T5, T6, T7> extends BaseLockTuple<Tuple8<T0, T1, T2, T3, T4, T5, T6, T7>> {
    public LockTuple8(Tuple8<T0, T1, T2, T3, T4, T5, T6, T7> base) { super(base); }
