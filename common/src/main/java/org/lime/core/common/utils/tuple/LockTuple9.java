...
public class LockTuple9<T0, T1, T2, T3, T4, T5, T6, T7, T8> extends BaseLockTuple<Tuple9<T0, T1, T2, T3, T4, T5, T6, T7, T8>> {
    public LockTuple9(Tuple9<T0, T1, T2, T3, T4, T5, T6, T7, T8> base) { super(base); }
