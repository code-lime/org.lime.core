...
public class Tuple3<T0, T1, T2> extends BaseTuple {
    public LockTuple3<T0, T1, T2> lock() { return new LockTuple3<>(this); }
    @Override public Object[] getValues() { return new Object[] { val0, val1, val2 }; }
    public Tuple3(T0 val0, T1 val1, T2 val2) { this.val0 = val0; this.val1 = val1; this.val2 = val2; }
    ...
    public void set(Tuple3<T0, T1, T2> other) { this.val0 = other.val0; this.val1 = other.val1; this.val2 = other.val2; }
    public <A0, A1, A2>Tuple3<A0, A1, A2> map(Func1<T0, A0> map0, Func1<T1, A1> map1, Func1<T2, A2> map2) { return Tuple.of(map0.invoke(val0), map1.invoke(val1), map2.invoke(val2)); }
