...
public class IterationEntityBuffer<T extends Entity>
    ...
    protected IterationEntityBuffer(EntityBufferStorage owner, BaseEntityBufferSetup<WorldLocation> setup, Class<T> tClass) {
        this((BaseEntityBufferStorage<Entity, WorldLocation>)owner, setup, tClass);
    }
    protected IterationEntityBuffer(BaseEntityBufferStorage<Entity, WorldLocation> owner, BaseEntityBufferSetup<WorldLocation> setup, Class<T> tClass) {
