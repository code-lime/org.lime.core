...
public class Toast7<T0, T1, T2, T3, T4, T5, T6> extends IToast {
    ...
    public void set(Toast7<T0, T1, T2, T3, T4, T5, T6> other) { this.val0 = other.val0; this.val1 = other.val1; this.val2 = other.val2; this.val3 = other.val3; this.val4 = other.val4; this.val5 = other.val5; this.val6 = other.val6; }
