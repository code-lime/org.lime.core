...
public class LimeCore extends CoreLoader {
    static {
        MutatePatcher.register();
    }

    public static LimeCore instance;
            ...
            try (JarFile jar = new JarFile(this.getFile())) {
                jar.entries().asIterator().forEachRemaining(entry -> {
                    ...
                    try {
                        ...
                        LimeCore.instance._logOP("ERROR LOAD: " + class_name);
                        LimeCore.instance._logStackTrace(e);
                    }
                });
            }
            catch (Exception e) {
